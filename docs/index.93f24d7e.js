...
const $6b84cfb86d6c6bc6$var$ZONE_SIZE = 16;
...
class $6b84cfb86d6c6bc6$export$75493ecd6c76042 {
    setCurrentZone(x, y) {
        this.currentZone = this.cells.filter((cell)=>cell.x >= x && cell.x < x + $6b84cfb86d6c6bc6$var$ZONE_SIZE && cell.y >= y && cell.y < y + $6b84cfb86d6c6bc6$var$ZONE_SIZE, []);
    ...
    constructor(draw, gridWidth, gridHeight = gridWidth){
        ...
        this.run = (drawSteps = false)=>{
            try {
                ...
                for(let y = 0; y < this.gridHeight; y += $6b84cfb86d6c6bc6$var$ZONE_SIZE)for(let x = 0; x < this.gridWidth; x += $6b84cfb86d6c6bc6$var$ZONE_SIZE)this.runZone(x, y);
        ...
        this.runAsync = async ()=>{
            for(let y = 0; y < this.gridHeight; y += $6b84cfb86d6c6bc6$var$ZONE_SIZE)for(let x = 0; x < this.gridWidth; x += $6b84cfb86d6c6bc6$var$ZONE_SIZE)await this.runZoneAsync(x, y);
            this.draw();
            console.log(`Finished in ${new Date().getTime() - this.startTime}ms`);
        };
        this.runZone = (x, y)=>{
...
const $65292ecc9a803d25$var$drawCell = (cell)=>{
    ...
    $65292ecc9a803d25$var$context.fillStyle = "#000";
...
const $65292ecc9a803d25$var$wfc = new (0, $6b84cfb86d6c6bc6$export$75493ecd6c76042)($65292ecc9a803d25$var$drawGrid, $65292ecc9a803d25$var$ROWS, $65292ecc9a803d25$var$COLUMNS);
$65292ecc9a803d25$var$wfc.run(true);


//# sourceMappingURL=index.93f24d7e.js.map
