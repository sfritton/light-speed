const $cbc4508c509700da$export$fc6599c381dbc8c3 = Math.max(100, Math.min(window.innerWidth - 300, 500));
...
class $17a7190886fee4ea$export$a4ab8c6fce437889 {
    ...
    draw() {
        ...
        this.context.fillText(`${(0, $cbc4508c509700da$export$fc6599c381dbc8c3)} stars at ${this.fps} fps`, 20, 40);
    }
    constructor(canvas){
        this.stars = [];
        this.prevMS = 0;
...
//# sourceMappingURL=index.36e59744.js.map
