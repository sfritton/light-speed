...
const $cbc4508c509700da$export$a4857d071325d417 = 4;
...
class $5115bcf1ae0af497$export$1644ba17714857f1 {
    init({ startAtOrigin: startAtOrigin = false } = {}) {
        this.z = startAtOrigin ? $5115bcf1ae0af497$var$randomRange((0, $cbc4508c509700da$export$bb9d82560b5a45d1), (0, $cbc4508c509700da$export$bb9d82560b5a45d1) + (0, $cbc4508c509700da$export$7bdd7d63613005f6)) : $5115bcf1ae0af497$var$randomRange(0, (0, $cbc4508c509700da$export$bb9d82560b5a45d1));
        ...
        this.radius = $5115bcf1ae0af497$var$randomRange(1, 1 + (0, $cbc4508c509700da$export$a4857d071325d417));
    }
    get x() {
...
class $17a7190886fee4ea$export$a4ab8c6fce437889 {
    ...
    onInitOrResize() {
        ...
        this.gradients = (0, $cbc4508c509700da$export$56d196d2844d1ca1).map((color)=>{
            ...
            gradient.addColorStop(0.04, `rgba(${color}, 0)`);
...
//# sourceMappingURL=index.d2d9002c.js.map
